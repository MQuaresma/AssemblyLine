...
const struct instr_table INSTR_TABLE[] = {
    ...
    {"divpd",       divpd,       {NA, vv},   RM,  VECTOR,         NA,  NA,  5,  {0x66, REX, 0x0f, 0x5e, REG}},
		{"emms",        emms,        {n,  n},    NA,  OTHER,          NA,  NA,  2,  {0x0f, 0x77}},
    ...
    {"movntq",      movntq,      {NA, mx},   MR,  VECTOR,         NA,  NA,  4,  {REX, 0x0f, 0xe7, REG}},
    ...
    {"movdq2q",     movdq2q,     {xv, NA},   RM,  VECTOR,         NA,  NA,  5,  {REX, 0xf2, 0x0f, 0xd6, REG}},
    {"movq2dq",     movq2dq,     {vx, NA},   RM,  VECTOR,         NA,  NA,  5,  {REX, 0xf3, 0x0f, 0xd6, REG}},
    ...
    {"pextrq",      pextrq,      {rvi, mvi}, MR,  VECTOR,         NA,  NA,  6,  {0x66, REX, 0x0f, 0x3a, 0x16, REG}},
